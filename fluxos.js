...
// } else {
//     console.log("Eu só vejo essa mensagem se X for menor que 20, ou seja, quando retorna falso.")
// }
...
function processaBarman(){
    ...
    // } else if (idade > 15) {
    //     //console.log("Aceita um suco de laranja?")
    //     mensagem.innerHTML= "Aceita um suco de laranja?"
    // } else {
